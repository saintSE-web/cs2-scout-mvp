...
4. Creates separate T and CT density maps for the selected player, calibrated onto the actual map radar.
...
- Radar artwork and overview calibration are fetched at runtime from [cs2-map-icons](https://github.com/MurkyYT/cs2-map-icons), which mirrors the current Valve game-depot assets. Those map assets remain property of Valve Corporation.
